...
DivergenceMainTemplatePlugin.prototype.apply = function(mainTemplate) {
    ...
    mainTemplate.plugin("require-diverge", function(source, chunk, hash) {
        ...
        return this.asString([
            ...
            "var base = (optionsFlag & " + DivergenceMainTemplatePlugin.OPTIONS_FLAG_ENUM.skipBase + " || baseId === -1) ? undefined : " + options.requireFn + "(baseId), /* skipBase */",
            this.indent("divergent = (i === -1) ? undefined : " + options.requireFn + "(divergents[i]);"),
            "if (base && divergent)",
